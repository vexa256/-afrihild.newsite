<div class="card-body pt-3 bg-light shadow-lg table-responsive">
    {!! Alert(
        $icon = 'fa-info',
        $class = 'alert-primary',
        $Title = 'AfriChild Website Research Database',
        $Msg = 'Manage information in the AfriChild Website Research database',
    ) !!}
</div>
<div class="card-body pt-3 bg-light shadow-lg table-responsive">
        ...
        <form enctype="multipart/form-data" action="{{ route('MassUpdate') }}"
            ...
            <div class="row">
                <div class="col-md-6 mb-3 mt-3 ">
                    <div class="mb-3">
                        <label class="required form-label">Research PDF</label>
                ...
                <input type="hidden" name="TableName" value="research">

                {{ RunUpdateModalFinal($ModalID = $up->id, $Extra = '', $csrf = null, $Title = null, $RecordID = $up->id, $col = '6', $te = '12', $TableName = 'research') }}
            </div>
