<div class="card-body pt-3 bg-light shadow-lg table-responsive">
    {!! Alert(
        $icon = 'fa-info',
        $class = 'alert-primary',
        $Title = 'Secretariat Teams ',
        $Msg = 'Manage information in the Secretariat Teams ',
    ) !!}
</div>
<div class="card-body pt-3 bg-light shadow-lg table-responsive">
    ...
    @foreach ($DatabaseData as $up)
        ...
        <form enctype="multipart/form-data" action="{{ route('MassUpdate') }}"
            ...
            <div class="row">
                ...
                <input type="hidden" name="TableName" value="sec_teams">

                {{ RunUpdateModalFinal($ModalID = $up->id, $Extra = '', $csrf = null, $Title = null, $RecordID = $up->id, $col = '6', $te = '12', $TableName = 'sec_teams') }}
            </div>
