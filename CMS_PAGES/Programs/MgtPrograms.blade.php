<div class="card-body pt-3 bg-light shadow-lg table-responsive">
    {!! Alert(
        ...
        $class = 'alert-primary',
        $Title = 'Program Areas ',
        $Msg = 'Manage information in the Program Areas ',
    ) !!}
</div>
<div class="card-body pt-3 bg-light shadow-lg table-responsive">
    ...
    @foreach ($DatabaseData as $up)
        ...
        <form enctype="multipart/form-data" action="{{ route('MassUpdate') }}"
            ...
            <div class="row">
                ...
                <input type="hidden" name="TableName" value="program_areas">

                {{ RunUpdateModalFinal($ModalID = $up->id, $Extra = '', $csrf = null, $Title = null, $RecordID = $up->id, $col = '6', $te = '12', $TableName = 'program_areas') }}
            </div>
