<div class="card-body pt-3 bg-light shadow-lg table-responsive">
    {!! Alert(
        $icon = 'fa-info',
        $class = 'alert-primary',
        $Title = 'AfriChild Founders Database',
        $Msg = 'Manage information in the AfriChild Founders database',
    ) !!}
</div>
<div class="card-body pt-3 bg-light shadow-lg table-responsive">
        ...
        <form enctype="multipart/form-data" action="{{ route('MassUpdate') }}"
            ...
            <div class="row">
                <div class="col-md-6 mb-3 mt-3 ">
                    <div class="mb-3">
                        <label class="required form-label">Founder'S Photo</label>
                ...
                <input type="hidden" name="TableName" value="founders">

                {{ RunUpdateModalFinal($ModalID = $up->id, $Extra = '', $csrf = null, $Title = null, $RecordID = $up->id, $col = '6', $te = '12', $TableName = 'founders') }}
            </div>
