<div class="card-body pt-3 bg-light shadow-lg table-responsive">
    {!! Alert(
        $icon = 'fa-info',
        $class = 'alert-primary',
        $Title = 'AfriChild Affiliates Database',
        $Msg = 'Manage information in the AfriChild Affiliates database',
    ) !!}
</div>
<div class="card-body pt-3 bg-light shadow-lg table-responsive">
    ...
    @foreach ($DatabaseData as $up)
        ...
        <form enctype="multipart/form-data" action="{{ route('MassUpdate') }}"
            ...
            <div class="row">
                ...
                <input type="hidden" name="TableName" value="affs">

                {{ RunUpdateModalFinal($ModalID = $up->id, $Extra = '', $csrf = null, $Title = null, $RecordID = $up->id, $col = '6', $te = '12', $TableName = 'affs') }}
            </div>
