<div class="card-body pt-3 bg-light shadow-lg table-responsive">
    {!! Alert(
        $icon = 'fa-info',
        $class = 'alert-primary',
        $Title = 'Research Associates Database',
        $Msg = 'Manage information in the Research Associates database',
    ) !!}
</div>
<div class="card-body pt-3 bg-light shadow-lg table-responsive">
    ...
    @foreach ($DatabaseData as $up)
        ...
        <form enctype="multipart/form-data" action="{{ route('MassUpdate') }}"
            ...
            <div class="row">
                ...
                <input type="hidden" name="TableName" value="assocs">

                {{ RunUpdateModalFinal($ModalID = $up->id, $Extra = '', $csrf = null, $Title = null, $RecordID = $up->id, $col = '6', $te = '12', $TableName = 'assocs') }}
            </div>
